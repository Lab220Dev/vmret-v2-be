...
async function relatorio(request, response) {
    ...
    `;
        ...
        if (params.id_usuario) dbRequest.input("id_usuario", sql.Int, params.id_usuario); // Define o parâmetro ID_Usuario se estiver presente
        if (params.operacao) dbRequest.input("operacao", sql.VarChar, params.operacao); // Define o parâmetro Operacao se estiver presente
        if (params.data_inicio) dbRequest.input("data_inicio", sql.DateTime, params.data_inicio); // Define o parâmetro Data_Inicio se estiver presente
        if (params.data_final) dbRequest.input("data_final", sql.DateTime, params.data_final); // Define o parâmetro Data_Final se estiver presente
...
async function relatorioMaquina(request, response) {
  ...
  `;
      ...
      if (params.id_usuario) dbRequest.input("id_usuario", sql.VarChar, params.id_usuario); // Define o parâmetro ID_Usuario se estiver presente
      if (params.operacao) dbRequest.input("operacao", sql.VarChar, params.operacao); // Define o parâmetro Operacao se estiver presente
      if (params.id_funcionario) dbRequest.input("id_funcionario", sql.VarChar, params.id_funcionario); // Define o parâmetro ID_Funcionario se estiver presente
      if (params.data_inicio) dbRequest.input("data_inicio", sql.DateTime, params.data_inicio); // Define o parâmetro Data_Inicio se estiver presente
      if (params.data_final) dbRequest.input("data_final", sql.DateTime, params.data_final); // Define o parâmetro Data_Final se estiver presente
