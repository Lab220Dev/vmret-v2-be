...
async function listarSetor(request, response) {
    try {
        ...
        const query = 'SELECT DISTINCT id_setor FROM funcionarios WHERE id_cliente = @id_cliente';
...
async function listarCdC(request, response) {
    try {
        ...
        const query = 'SELECT DISTINCT id_centro_custo FROM funcionarios WHERE id_cliente = @id_cliente';
